...
- 媒体文件 Upper 路径：`/storage/emulated/{user}/Android/media/{uid_name}/sdcard_redirect/`  
- 非媒体文件 Upper 路径：`/storage/emulated/{user}/Android/data/{uid_name}/files/sdcard_redirect/`  
